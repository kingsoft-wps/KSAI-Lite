...
TFL_CAPI_EXPORT extern TfLiteStatus TfliteTensorWriteModelBuffer(
    TfLiteModel* model, size_t graph_index, const char* tensor_name,
    const void* model_buffer, size_t data_size);
